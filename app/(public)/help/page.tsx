                  ...
                  <div className="space-y-8">
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        ...
                        <a href="mailto:support@warp5.com" className="text-white hover:text-green-400 transition-colors font-medium">info@warp5construction.com</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        ...
                        <a href="tel:+233200000000" className="text-white hover:text-green-400 transition-colors font-medium">+233 543 839 253</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        ...
                        <span className="text-white font-medium">Greenville Street, Abuakwa-Kumasi, Ghana</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleFormSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full h-32 p-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 focus:outline-none transition-all resize-none"
                    ></textarea>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full h-14 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-green-600/20 active:scale-95 text-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
