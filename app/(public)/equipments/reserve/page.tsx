            ...
            <div className="bg-white rounded-[2rem] p-6 md:p-10 shadow-sm border border-gray-100">
              ...
              <div className="mt-8 overflow-hidden rounded-xl border border-gray-100">
                <table className="w-full text-left bg-gray-50/50">
                  <thead className="bg-gray-100/50 text-gray-400 text-[10px] uppercase tracking-wider">
                    <tr>
                  ...
                  <tbody className="divide-y divide-gray-100 text-sm">
                    <tr>
                      ...
                      <td className="px-4 py-4 text-gray-600">GH₵ {price.toLocaleString()}</td>
                      <td className="px-4 py-4 text-gray-600">{duration} Days</td>
                      <td className="px-4 py-4 font-bold text-green-600">GH₵ {total.toLocaleString()}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
