        ...
        <section className='mt-6 lg:mt-8 w-[85vw] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8'>
          ...
          <div className='shadow-xl px-6 lg:px-12 xl:px-20 py-6 lg:py-8 rounded-4xl'>
            ...
            <div className='mt-6 lg:mt-8'>
              <div className='flex flex-col space-y-4 lg:space-y-6'>
                <div className='flex items-center space-x-3 lg:space-x-6'>
                  ...
                  <h1 className='text-[#333333] text-xs lg:text-base font-medium'>Digging Depth: 15 - 25 Feet</h1>
                </div>

                <div className='flex items-center space-x-3 lg:space-x-6'>
                  <i className="ri-check-line text-[#43A047]"></i>
                  <h1 className='text-[#333333] text-xs lg:text-base font-medium'>Lifting Capacity: 12,000 Pounds</h1>
                </div>

                <div className='flex items-center space-x-3 lg:space-x-6'>
                  <i className="ri-check-line text-[#43A047]"></i>
                  <h1 className='text-[#333333] text-xs lg:text-base font-medium'>Fuel Type: Diesel</h1>
                </div>
                ...
                <div className='mt-8 lg:mt-12'>
                  <div className='flex flex-col lg:flex-row justify-between items-center gap-3 lg:gap-6'>
                    ...
                    <div className='flex justify-center items-center bg-[#43A047] text-white w-full h-10 lg:h-12 rounded-full space-x-2'>
                      ...
                      <h1 className='text-xs lg:text-base'>Chat Vendor</h1>
                    </div>
                    ...
                    <div className='flex justify-center items-center bg-[#fff] border border-[#333333] text-[#333333] w-full h-10 lg:h-12 rounded-full space-x-2'>
                      ...
                      <h1 className='text-xs lg:text-base'>Report</h1>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='mt-8 lg:mt-12'>
              <div className='flex justify-between items-center'>
                <h1 className='text-[#333333] font-bold text-sm lg:text-lg'>Total Amount</h1>
                <h1 className='text-[#333333] font-bold text-sm lg:text-lg'>GH 300000</h1>
              </div>
            </div>
          </div>
          ...
          <div className='px-6 lg:px-12 xl:px-24'>
            <div className='flex justify-center items-center'>
              <h1 className='text-[#43A047] font-bold text-base lg:text-xl'>Confirm Your Reservation</h1>
            </div>
            ...
            <div className='mt-6 lg:mt-8'>
              <div className='flex flex-col space-y-6 lg:space-y-8'>
                ...
                <div className='flex flex-col space-y-2'>
                  <h1 className='text-[#43A047] font-semibold text-sm lg:text-lg'>Pickup</h1>
                  <h1 className='text-[#333333] font-regular text-xs lg:text-base'>1 November, 2025</h1>
                </div>

                <div className='flex flex-col space-y-2'>
                  <h1 className='text-[#43A047] font-semibold text-sm lg:text-lg'>Return</h1>
                  <h1 className='text-[#333333] font-regular text-xs lg:text-base'>12 November, 2025</h1>
                </div>
