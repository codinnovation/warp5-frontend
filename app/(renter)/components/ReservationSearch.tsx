...
function ReservationSearch() {
  ...
  return (
    <>
      <div className='relative z-10 flex flex-col justify-end items-center h-full px-8'>
        <div className='bg-white/30 backdrop-blur-sm rounded-4xl px-12 py-5 max-w-7xl w-full border border-[#333333] cursor-pointer' onClick={() => {
          setShowLocationDropdown(false);
          setShowEquipmentDropdown(false);
          setShowPriceDropdown(false);
          setShowDateDropdown(false);
          ...
          <div className='grid grid-cols-5'>
            ...
            <div className='flex flex-col items-start justify-center space-y-2 border-r-[1px] border-[#DDDDDDB2]'>
              <h1 className='text-[#333333] text-lg font-medium'>Location</h1>
              <div className='flex space-x-2 items-center hover:scale-105 transition-transform duration-500 cursor-pointer relative' onClick={handleLocationClick}>
                <h1 className='text-[#787878] font-regular tracking-wide text-sm'>{city || 'Select Your City'}</h1>
                <i className="ri-arrow-down-s-line text-[#787878] text-lg"></i>
              </div>
            ...
            <div className='flex flex-col items-start justify-center space-y-2 border-r-[1px] border-[#DDDDDDB2] pl-8'>
              <h1 className='text-[#333333] text-lg font-medium'>Equipment</h1>
              <div className='flex space-x-2 items-center hover:scale-105 transition-transform duration-500 cursor-pointer relative' onClick={handleEquipmentClick}>
                <h1 className='text-[#787878] font-regular tracking-wide text-sm'>{equipment || 'Choose Type'}</h1>
                <i className="ri-arrow-down-s-line text-[#787878] text-lg"></i>
              </div>
            ...
            <div className='flex flex-col items-start justify-center space-y-2 border-r-[1px] border-[#DDDDDDB2] pl-8'>
              <h1 className='text-[#333333] text-lg font-medium'>Price Range</h1>
              <div className='flex space-x-2 items-center hover:scale-105 transition-transform duration-500 cursor-pointer relative' onClick={handlePriceClick}>
                <h1 className='text-[#787878] font-regular tracking-wide text-sm'>{(minPrice || maxPrice) ? `${minPrice || '0'} - ${maxPrice || '∞'}` : 'Choose Range'}</h1>
                <i className="ri-arrow-down-s-line text-[#787878] text-lg"></i>
              </div>
            ...
            <div className='flex flex-col items-start justify-center space-y-2 pl-8'>
              <h1 className='text-[#333333] text-lg font-medium'>Date</h1>
              <div className='flex space-x-2 items-center hover:scale-105 transition-transform duration-500 cursor-pointer relative' onClick={handleDateClick}>
                <i className="ri-calendar-2-line text-[#787878] text-lg"></i>
                <h1 className='text-[#787878] font-regular tracking-wide text-sm whitespace-nowrap'>{(startDate && endDate) ? `${startDate} - ${endDate}` : '**/**/**** -**/**/****'}</h1>
              </div>
