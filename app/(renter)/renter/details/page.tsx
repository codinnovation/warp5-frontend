  ...
  return (
    <>
      <main className='bg-white'>
        ...
        <section className='w-[85vw] mx-auto grid grid-cols-1 lg:grid-cols-[2.5fr_1fr] gap-12'>
            ...
            <div className='mt-4'>
              <div className='flex flex-col'>
                <div className='flex items-center space-x-1'>
                  <h1 className={`flex justify-center items-center ${activeTab === 'description' ? 'bg-[#F4F4F4] text-[#333333]' : 'bg-[#333333] text-white'} text-lg font-medium w-40 h-16`} onClick={() => setActiveTab('description')}>Description</h1>
                  <h1 className={`flex justify-center items-center ${activeTab === 'rate' ? 'bg-[#F4F4F4] text-[#333333]' : 'bg-[#333333] text-white'} text-lg font-medium w-40 h-16`} onClick={() => setActiveTab('rate')}>Rate</h1>
                  <h1 className={`flex justify-center items-center ${activeTab === 'availability' ? 'bg-[#F4F4F4] text-[#333333]' : 'bg-[#333333] text-white'} text-lg font-medium w-40 h-16`} onClick={() => setActiveTab('availability')}>Availability</h1>
                </div>

                {activeTab === 'description' && (
                  <div className='bg-[#F4F4F4] min-h-[10vh] max-h-96 rounded-b-3xl p-16 overflow-y-auto'>
                    <h1 className='text-[#333333] text-base tracking-wider font-regular'>Lorem ipsum dolor sit amet, {description}
                    </h1>
                  </div>
                )}

                {activeTab === 'rate' && (
                  <div className='bg-[#fff] min-h-[10vh] max-h-96 shadow-md rounded-b-3xl p-20 overflow-y-auto'>
                    <div className='flex justify-around items-center'>
                      <div className='flex flex-col'>
                        <h1 className='text-[#333333] text-base font-medium'>Daily</h1>
                      ...
                      <div className='flex flex-col'>
                        ...
                        <h1 className='text-[#333333] text-2xl font-bold'>GH 2500.00</h1>
                      </div>

                      <div className='border-l border-[#333333] h-14' />

                      <div className='flex flex-col'>
                        <h1 className='text-[#333333] text-base font-medium'>Weekly</h1>
                        <h1 className='text-[#333333] text-2xl font-bold'>GH 7020.00</h1>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {activeTab === 'availability' && (
                  <div className='bg-[#F4F4F4] min-h-[10vh] max-h-96 rounded-b-3xl p-16 overflow-y-auto'>
                    <h1 className='text-[#333333] text-base tracking-wider font-regular'>Availability content goes here.</h1>
                  </div>
                )}
            ...
            <div className='mt-16'>
              <div className='flex flex-col space-y-4'>
                <div className='flex justify-start items-center'>
                  <h1 className='text-[#333333] font-medium text-2xl'>Equipment Location On Map</h1>
                </div>
          ...
          <div className='flex flex-col'>
            ...
            <div className='mt-20 py-12 flex flex-col justify-center shadow-xl rounded-b-4xl'>
              ...
              <div className='relative mt-16 flex justify-center'>
                <div
                  className='flex justify-center items-center border border-[#787878] w-68 mx-auto h-14 rounded-full space-x-2 cursor-pointer bg-white'
