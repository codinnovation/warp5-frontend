                ...
                >
                    {isLoading ? (
                        Array.from({ length: 6 }).map((_, i) => (
                            <div key={i} className="w-[85%] md:w-[calc(33.333%-1rem)] lg:w-[calc(25%-1.125rem)] xl:w-[calc(20%-1.2rem)] flex-none snap-start">
                                <EquipmentCardSkeleton />
                            </div>
                        ))
                    ) : (
                        data?.map((item: Equipment, index: number) => (
                            <div key={index} className="w-[85%] md:w-[calc(33.333%-1rem)] lg:w-[calc(25%-1.125rem)] xl:w-[calc(20%-1.2rem)] flex-none snap-start">
                                <EquipmentCard
                                    item={{
                                        id: item.id,
