      ...
      <div className='h-32 bg-white flex items-center justify-center'>
        <div className='w-[85vw] mx-auto grid grid-cols-3 '>
          ...
          <div className='flex justify-center items-center space-x-2'>
            ...
            <div className={`${pathname === '/home' ? 'bg-[#43A047] text-white' : 'text-[#333333] bg-white'} flex justify-center items-center w-52 h-14 cursor-pointer rounded-full transition-all duration-300 hover:scale-105`} onClick={() => router.push('/home')}>
              <h1 className='text-lg font-medium'>Home</h1>
            </div>

            <div className={`${pathname === '/dashboard' ? 'bg-[#43A047] text-white' : 'text-[#333333] bg-white'} flex justify-center items-center w-52 h-14 cursor-pointer rounded-full transition-all duration-300 hover:scale-105`} onClick={() => router.push('/dashboard')}>
              <h1 className='text-lg font-medium'>Dashboard</h1>
            </div>

            <div className={`${pathname === '/help' ? 'bg-[#43A047] text-white' : 'text-[#333333] bg-white'} flex justify-center items-center w-52 h-14 cursor-pointer rounded-full transition-all duration-300 hover:scale-105`} onClick={() => router.push('/help')}>
