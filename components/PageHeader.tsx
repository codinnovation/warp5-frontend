...
function PageHeader() {
  return (
    <>
      <div className='w-[85vw] mx-auto h-28 grid grid-cols-3 items-center justify-center'>
        ...
        <div className='flex justify-end items-center space-x-10'>
          ...
          <div className='flex justify-center items-center border-[1px] border-[#333333] w-40 h-14 rounded-full cursor-pointer hover:bg-gray-100 hover:scale-105 transition-all duration-300'>
