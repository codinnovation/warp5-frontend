      ...
      <div className='fixed inset-0 bg-black/70 bg-opacity-50 flex items-center justify-center z-50'>
        <div className='bg-white rounded-3xl px-16 py-8 w-full max-w-lg relative'>
          ...
          <div className='text-center mb-6 mt-12 space-y-6'>
            <h2 className='text-2xl font-bold text-[#333333]'>Account Type</h2>
          </div>

          <form className='space-y-8' onSubmit={(e) => { e.preventDefault(); onContinue(); }}>
            <div className='flex justify-between items-center border border-[#787878] rounded-2xl'>
              <div className='flex flex-col'>
                <h1>Hirer</h1>
                <p>You&apos;re looking to rent equipment</p>
              </div>
